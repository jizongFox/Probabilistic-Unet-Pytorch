...
class Encoder(nn.Module):
    ...
    def __init__(self, input_channels, num_filters, no_convs_per_block, initializers, padding=True, posterior=False):
        ...
        if posterior:
            # To accommodate for the mask that is concatenated at the channel axis, we increase the input_channels.
...
class Fcomb(nn.Module):
    ...
    def forward(self, feature_map, z):
        """
        Z is batch_size x latent_dim and feature_map is batch_sizexno_channelsxHxW.
